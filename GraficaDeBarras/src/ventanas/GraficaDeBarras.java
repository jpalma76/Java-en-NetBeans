...
public class GraficaDeBarras extends javax.swing.JFrame {
    ...
    public void paint(Graphics g){
        ...
        if (bandera == true){
            ...
            int largo_rojo = int_rojo * 300 / valor_Mayor;
            int largo_verde = int_verde * 300 / valor_Mayor;
            int largo_azul = int_azul * 300 / valor_Mayor;
            
            g.setColor(new Color(255,0,0));
            g.fillRect(100, 100, largo_rojo, 30);
            g.drawString("Color Rojo", 10, 125);
            
            g.setColor(new Color(0,170,0));
            g.fillRect(100, 150, largo_verde, 30);
            g.drawString("Color Verde", 10, 175);
            
            g.setColor(new Color(0,0,255));
            g.fillRect(100,200,largo_azul,30);
            g.drawString("Color azul", 10, 215);
        }
    }
}

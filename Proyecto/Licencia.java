...
public class Licencia extends JFrame implements ActionListener, ChangeListener{
  ...
  public Licencia(){
    setLayout(null);
    setTitle("Licencia dse uso");
    setDefaultCloseOperation(EXIT_ON_CLOSE);
    setFont(new Font("Andale Mono", 1, 12));
    ...
    textarea1.setText("\n\n          TERMINOS Y CONDICIONES" +
                    ...
                    "\n            C.  EL PROGRAMADOR DECLARA QUE NO SE HACE RESPONSABLE DEL MAL USO DE ESTE SOFTWARE." +
                    "\n\n          LOS ACUERDOS LEGALES EXPUESTOS ACONTINUACION RIGEN EL USO QUE USTED HAGA DE ESTE SOFTWARE" +
                    "\n          (JUAN PALMA INC Y SU SUS ASOCIADOS, O SEA YO), NO SE RESPONSABILIZAN DEL USO QUE USTED" + 
    ...
    label2.setBounds(310,130,300,300);
    add(label2);
  }

...
public class Cadena{
  public static void main(String args[]){
   ...
   System.out.print("Desde que caracter deseas obtener la nueva cadena de caracteres: ");
   desde = in.nextInt();

   System.out.print("hasta que caracter deseas obtener la nueva cadena de caracteres: ");
   hasta = in.nextInt();   

...
public class MenuEmpleados extends JFrame implements ActionListener{
  ...
  public MenuEmpleados(){
    setLayout(null);
    setTitle("Interface de Empleados");
    setDefaultCloseOperation(EXIT_ON_CLOSE);
    getContentPane().setBackground(new Color(100,100,255));

    label1 = new JLabel("Menu de Empleados:");
    ...
    boton6 = new JButton("6.- Salir");
    boton6.setBounds(190,130,140,20);
    boton6.setBackground(new Color(230,230,230));
    boton6.setFont(new Font("Times new Roman",1,14));
    boton6.setForeground(new Color(0,0,255));
    add(boton6);

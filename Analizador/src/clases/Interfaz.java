...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_expresion.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    ...
    private void boton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton1ActionPerformed
          if (ValidarExpresion()) {
            JOptionPane.showMessageDialog(null, "La fórmula está escrita correctamente");
        } else {
            JOptionPane.showMessageDialog(null, "Error, La fórmula está mal escrita");
        }
